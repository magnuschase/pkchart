...
public class PortfolioController {
  ...
  public ResponseEntity<PortfolioDTO> getPortfolio(
    ...
    PortfolioDTO cardApprovalRequest = portfolioService.getPortfolioForUser(userDetails);
  ...
  public ResponseEntity<PortfolioDTO> addCard(
    ...
    PortfolioDTO dto = portfolioService.addCard(userDetails, portfolioAddCardRequestDTO, cardId);
    return ResponseEntity.ok(dto);
  }

  @DeleteMapping("/remove/{entryId}")
  public ResponseEntity<PortfolioDTO> removeCard(
      @AuthenticationPrincipal UserDetails userDetails, @PathVariable Long entryId) {
    PortfolioDTO dto = portfolioService.removeCard(userDetails, entryId);
    return ResponseEntity.ok(dto);
  }
}
