...
public class MarketplaceSteps {
  ...
  @When(
      "The user creates a sale listing for {string} from set {string} and condition {string} with price {double} PLN")
  public void the_user_creates_a_sale_listing(
      String cardName, String setName, String condition, double price) {
  ...
  public void it_should_include_card_name_price_contact() {
    ...
    Assertions.assertTrue(
        body.contains("ash.ketchum@palettetown.com")); // or whatever contact info is expected
  }

  @When(
      "The user creates a buy offer for {string} from set {string} and condition {string} with offer price {double} PLN")
  public void the_user_creates_a_buy_offer(
      String cardName, String setName, String condition, double price) {
  ...
  private Long findPortfolioEntryId(String cardName, String setName, String condition) {
    ...
    throw new AssertionError(
        "Portfolio entry not found for: " + cardName + ", " + setName + ", " + condition);
  }
}
