...
public class PortfolioManagementSteps {
    ...
    public String generateSymbol(String setName) {
        ...
        String symbol = Arrays.stream(setName.split("\\s+"))
    ...
    public void current_price_of_card_is(String cardName, String setName, double price) {
        // TODO: /admin/prices/update endpoint should be used
    }
    ...
    public void user_removes_card_from_portfolio(String cardName, String setName) {
        ...
        // Iterate through cards to find the entryid
				...
				PortfolioEntryDTO entry = portfolio.getCards().stream()
								.filter(e -> cardName.equals(e.getCard().getName()) && setName.equals(e.getCard().getSet().getName()))
								.findFirst()
								.orElseThrow(() -> new AssertionError("Card not found in portfolio: " + cardName + " from set " + setName));
